...
Route::post('review', 'ApiReviewController@store');
Route::get('review/{id}/menu/{idMenu}', 'ApiReviewController@show');
...
Route::get('picture/{id}/menu/{idMenu}', 'ApiPictureController@show');
