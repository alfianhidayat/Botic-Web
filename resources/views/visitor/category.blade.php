            ...
            <div class="modal-content">
                <form role="form" method="post" action="export">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label>Dari</label>
                            <input id="dateField" type="date" min="2014-01-01" disabled name="from" class="form-control" placeholder="Dari"
                                   required/>
                        </div>
                        <div class="form-group">
                            <label>Sampai</label>
                            <input id="dateField" type="date" min="2014-01-01" disabled name="until" class="form-control" placeholder="Sampai"
                                   required/>
                        </div>
                    </div>
                    <div class="modal-footer">
