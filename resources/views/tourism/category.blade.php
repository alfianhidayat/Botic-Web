                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center;">
                                            <a class="btn btn-social btn-primary"
                                               href="{{$item->id}}/{{$item->id_category}}/{{$item->id_menu}}/view">
                                                <i class="fa fa-eye"></i>
                                            </a>
                                            <a class="btn btn-social btn-warning"
                                               href="{{$item->id}}/{{$item->id_menu}}/edit">
                                                <i class="fa fa-pencil"></i>
                                            </a>
                                            {{--<a href="{{$item->id}}/{{$item->id_menu}}/delete" id="del{{$item->id}}"></a>--}}
                                            <form action="{{$item->id}}/{{$item->id_menu}}/delete" method="post"
                                                  id="del{{$item->id}}">
                                                <input type="hidden" value="{{csrf_token()}}" name="_token"/>
